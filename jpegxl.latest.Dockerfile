...
run ldd build/tools/cjpegxl

from ubuntu

copy --from=build /jpeg-xl/build/tools/cjpegxl /cjpegxl
copy --from=build /jpeg-xl/build/tools/cjpegxl /djpegxl
#run apt update
#run apt install -y libjpeg8 libgif7 libpng16-16 openexr 
